...
<!--<img class="centered" id="joinMeImg" src="images/ME_White_Square.png" alt="Join me" style="margin-top:30px;width:326px;height:326px;"/>
<img class="centered" id="joinMeImg" src="images/JOIN_ME_White_Square.png" alt="Join me" style="margin-top:30px;width:326px;height:326px;"/>-->
